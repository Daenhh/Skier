...
class ObstacleClass(pygame.sprite.Sprite):
    def __init__(self, image_file, location, type):         #创建树和小旗
        pygame.sprite.Sprite.__init__(self)
    ...
    def update(self):                                       #让场景向上滚
        ...
        if self.rect.centery < -32:                         #删除从屏幕上方滚下的障碍物
            self.kill()
...
while running:
    ...
    for event in pygame.event.get():                        #检查按键或窗口是否关闭
